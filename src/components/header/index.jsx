    ...
    <div className="w-full bg-black px-10 py-6">
      ...
      {open && (
        <div className="flex flex-col gap-6 mt-4 md:hidden text-white font-semibold">
          ...
          <Link
            href="/"
            className="bg-linear-to-r from-purple-600 to-blue-500 bg-clip-text text-transparent"
          >
            Home
          </Link>
          ...
          <div className="flex gap-4 items-center">
            ...
            <Link
              href="https://github.com/eabeljohn453"
              target="_blank"
            >
              <Image
                src="/assets/git.svg"
            ...
            <Link
              href="https://in.linkedin.com/in/eabel-john-656997270"
              target="_blank"
            >
              <Image
      ...
      <div className="hidden md:flex justify-between items-center mt-6">
        ...
        <div className="flex justify-center gap-20 items-center">
          ...
          <Link href="/">
            <h1
              className="relative h-14 flex justify-center items-center text-[20px] font-bold cursor-pointer transition-all duration-300 text-center rounded-xl z-10
              after:content-[''] after:absolute after:bottom-2 after:left-0 after:h-[3px] after:w-0
              after:bg-linear-to-r after:from-[#8010B7] after:to-[#AC21B1]
