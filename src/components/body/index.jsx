...
export default function Body() {
    return (
        <div className=" flex flex-col  items-center    w-full  md:h-[800px] bg-black">
            <div className="flex ">
                <Image src="/assets/photo/arrows.svg" alt="Body Image"  width={100} height={100} className="hidden md:block bg-black ml-120 mt-14 " />
            ...
            <div className="relative w-[200px] mt-4  md:w-[220px] md:h-[220px] rounded-full p-1 bg-linear-to-tr from-[#ff00cc] via-[#a100ff] to-[#00d4ff]">
            ...
            <h1 className="md:text-[50px] text-[35px] font-bold leading-tight mt-10 text-center">
            ...
            <p className="mt-6 md:mt-8 md:text-[18px] text-[15px] leading-[1.8] text-gray-300 px-6 text-center">
  I’m a passionate full-stack developer who loves building sleek, scalable, and
  user-focused digital experiences.
</p>

<p className="mt-1 md:text-[18px] text-[15px] leading-[1.8] text-gray-300 px-6 text-center">
...
<p className="mt-1 md:text-[18px] text-[15px] leading-[1.8] text-gray-300 px-6 text-center">
  My focus is on creating clean, efficient, and high-performing solutions that make a real impact.
            ...
            <div className="flex md:gap-x-20 gap-x-2 mt-12 ">

                <Link href="/contact" className="border border-white w-36  h-12 flex items-center justify-center rounded-3xl font-semibold 
  text-white transition-all duration-300 
  hover:bg-linear-to-r hover:from-purple-800 
    hover:border-black  ">
                    Get In Touch
                </Link>
                <Link href="/assets/Eabel cv.pdf" className="border border-white w-36  h-12 flex items-center justify-center  rounded-3xl font-semibold 
  text-white transition-all duration-300 
  hover:bg-linear-to-r hover:from-purple-800 
    hover:border-black  ">
                    Download CV
            ...
            <h1 className="md:mt-20 mt-12 font-semibold text-4xl 
